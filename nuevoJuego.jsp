    ...
    <header class="mt-0 pt-0">
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                            <form class="login100-form validate-form" action="ServletNuevoJuego" method="POST">
					<span class="login100-form-title p-b-49">
						DreamLand
					</span>

					<div class="wrap-input100 validate-input m-b-23" data-validate = "Nombre es requerido">
						<span class="label-input100">Nombre del juego</span>
						<input class="input100" type="text" name="nombre" placeholder="Ingrese Nombre del juego">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-23" data-validate="Horario de apertura es requerido">
						<span class="label-input100">Horario de Apertura</span>
						<input class="input100" type="time" value="08:00" step="60" max="22:45" min="08:00" name="horarioInicio" placeholder="Ingrese Horario de Cpertura">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
                                        
                                        <div class="wrap-input100 validate-input m-b-23" data-validate="Horario de cierre es requerido">
						<span class="label-input100">Horario de Cierre</span>
						<input class="input100" type="time" value="08:00" step="60" max="22:45" min="08:00" name="horarioCierre" placeholder="Ingrese Horario de Cierre">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
